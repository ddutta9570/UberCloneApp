...
public class PassengerAvtivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenger_avtivity);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                updateCameraPassegerLocation(location);
      ...
      if (Build.VERSION.SDK_INT < 23){
         ...
         if (ContextCompat.checkSelfPermission(PassengerAvtivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){



          ActivityCompat.requestPermissions(PassengerAvtivity.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},1000);
             ...
             updateCameraPassegerLocation(currentPassengerLocation);
    ...
    private void updateCameraPassegerLocation(Location pLocation){
                ...
                requestCar.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e==null) {
                            ...
                            Toast.makeText(PassengerAvtivity.this,"Car request is sent" , Toast.LENGTH_SHORT).show();
                            ...
                            uberRequest.deleteInBackground(new DeleteCallback() {
                                ...
                                public void done(ParseException e) {
                                    ...
                                    if (e==null){
                                        ...
                                        Toast.makeText(PassengerAvtivity.this,"Request deleted" ,Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                        }
